    ...
    <section class="featured">
        <div class="featured-inner">
            ...
            <div class="featured-img-wrap">
                <img class="featured-img" src="../resources/img/home/1.jpeg" alt="Hiking">
            </div>

            <!-- Right: card -->
            <div class="featured-card">
                <span class="featured-tag">HIKING</span>
                <h2 class="featured-title">Topic Or <span class="accent">Something</span></h2>
                <div class="featured-body">
                    ...
                    <p>Lorem Ipsum has been the standard dummy text. Lorem ipsum is simply dummy text of the printing
