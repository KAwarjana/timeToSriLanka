    ...
    <section class="services">
        ...
        <div class="card card--image-left">
            ...
            <div class="card__content">
                <span class="card__label">SERVICE 1</span>
                <h2 class="card__title">Topic For <em>Service</em></h2>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                    industry's standard dummy text ever since the 1500s. Lorem Ipsum is simply dummy text of the
                    printing and typesetting industry.</p>
                <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s. Lorem Ipsum is simply
